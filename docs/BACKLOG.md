...
- **Status:** Open — pertanyaan tarif **sudah terjawab** 2026-08-01 (lihat `[BL-041]`); sisanya murni pekerjaan kode
- **Prioritas:** High
- **Area Terdampak:**
...
- **Usulan Perbaikan:**
  ...
  ~~**Kerjakan `[BL-030]` sebelum (b).**~~ — **selesai 2026-08-05, jendelanya terpakai.** Yang perlu dibawa ke butir (b): penerbit otomatis harus memakai `SubscriptionService::renewPeriod()` sebagai satu-satunya cara memajukan periode, dan aturan "tunggakan tidak ditumpuk" di sana **perlu ditinjau ulang di sini** — begitu tiap periode punya tagihannya sendiri, memajukan periode melewati bulan yang terlewat berarti melewati tagihannya juga.
