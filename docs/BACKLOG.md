...
- **Usulan Perbaikan (urut; butir 1 berdiri sendiri sepenuhnya):**
  ...
  2. **Baru definisikan bundelnya**, sesudah keputusan di bawah turun. Keputusannya turun 2026-09-15 dan 2026-09-16. **Urutan di dalam butir ini ditetapkan pemilik 2026-09-16:**
     - **2a. Struk lebih dulu** — baris potongan tercetak di struk layar (`ReceiptModal.vue`) dan struk printer (`escpos.js`), untuk diskon per barang yang sudah ada. Alasan pemilik: transparan, supaya pelanggan tidak kaget. Paket menumpang baris yang sama begitu ia lahir. Lihat "Persiapan" butir 2.
