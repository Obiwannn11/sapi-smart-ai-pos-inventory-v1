...
- **Status:** In Progress — **tahap 1 selesai 2026-09-06** (`ProductController::index()` membaca `?q=`, halaman Produk punya kotak pencarian yang mencocokkan nama produk, kategori, dan varian). Tahap 2 dan 3 masih terbuka, dan tahap 2 masih menunggu satu keputusan pemilik di bawah. Lihat `[ADDITION] Katalog Produk Akhirnya Bisa Dicari — dan Kata Kuncinya Boleh Datang dari URL (BL-100 Tahap 1)` di `docs/CHANGELOG.md`.
