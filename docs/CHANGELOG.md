...
- **Layoutnya diukur, bukan dikira-kira.** Markup kisinya dirender terhadap CSS hasil build proyek sendiri, dengan sidebar tiruan selebar aslinya, lalu tiap kontrol diukur `scrollWidth` vs `clientWidth` pada empat lebar: 1440, 1100 (kasus desktop tersempit), 820 (dua kolom), dan 390 (satu kolom). Tidak ada satu pun yang terpotong pada bentuk yang dikirim; angka 111px vs 150px di atas datang dari pengukuran itu. Berkas periksanya dihapus setelah dipakai.
